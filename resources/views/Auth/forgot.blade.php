...
<html lang="en">
    ...
    <body class="hold-transition bg-img" style="background-image: url(http://ultimatepro-admin-templates.multipurposethemes.com/images/auth-bg/banner.jpg);" data-overlay="1">
                ...
                <div class="col-12">
                    <div class="row no-gutters">
                        <div class="col-lg-4 col-md-5 col-12">
                            ...
                            <div class="p-30 content-bottom rounded bg-img box-shadowed" style="background-image: url(http://ultimatepro-admin-templates.multipurposethemes.com/images/auth-bg/bg.jpg);" data-overlay="8">
                                <form action="http://ultimatepro-admin-templates.multipurposethemes.com/light-sidebar/index.html" method="post">

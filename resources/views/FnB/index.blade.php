                        ...
                        <div class="box-header bg-danger">
                            <div class="row mb-4">
                                <div class="col-6 text-left">
                                    <p class="text-uppercase mb-0">#ord00921</p>
                                    <p class="text-capitalize mb-0">8 Item</p>
                                </div>
                                <div class="col-6 text-right">
                                    <p class="box-title mb-0">14:00</p>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-12">
                                    <p class="font-size-11 text-uppercase text-bold mb-0">Room</p>
                                    <p class="">Large meeting room</p>
                                </div>
                                <div class="col-12">
                                    <p class="font-size-11 text-uppercase text-bold mb-0">PIC</p>
                                    <p class="mb-0">Otilia Pegasus Haluk</p>
                                </div>
                            </div>
                        </div>
                        <div class="box-body pt-0 pb-0" style="margin-bottom: -1px">
                            <div class="row">
                                ...
                                <div class="col-12">
                                    <ul class="nav d-block nav-stacked border-bottom border-top" style="padding-top: 1rem">
                                        <li class="nav-item">
                                            <p class="text-capitalize">French fries<span class="pull-right badge bg-dark">1</span></p>
                                        </li>
                                        <li class="nav-item">
                                            <p class="text-capitalize">Cheese toast<span class="pull-right badge bg-dark">1</span></p>
                                        </li>
                                    </ul>
                                </div>
                            </div>
                            <div class="row ">
                                ...
                                <div class="col-12">
                                    <ul class="nav d-block nav-stacked border-bottom border-top" style="padding-top: 1rem">
                                        <li class="nav-item">
                                            <p class="text-capitalize">Hot water<span class="pull-right badge bg-dark">1</span></p>
                                        </li>
                                        <li class="nav-item">
                                            <p class="text-capitalize">Hot cappucino<span class="pull-right badge bg-dark">1</span></p>
                                        </li>
                                        <li class="nav-item">
                                            <p class="text-capitalize">Black Coffee<span class="pull-right badge bg-dark">1</span></p>
                                        </li>
                                        <li class="nav-item">
                                            <p class="text-capitalize">Hot Tea<span class="pull-right badge bg-dark">1</span></p>
                                        </li>
                                    </ul>
                                </div>
                            </div>
                            <div class="row ">
                                ...
                                <div class="col-12">
                                    <ul class="nav d-block nav-stacked border-bottom border-top" style="padding-top: 1rem">
                                        <li class="nav-item">
                                            <p class="text-capitalize">Ice Chocolate<span class="pull-right badge bg-dark">1</span></p>
                                        </li>
                                        <li class="nav-item">
                                            <p class="text-capitalize">Thai tea<span class="pull-right badge bg-dark">1</span></p>
                                        </li>
                                    </ul>
                                </div>
                            </div>
                ...
                <div class="col-sm-4">
                    <div class="box">
                        <div class="box-header bg-primary">
                            <div class="row mb-4">
                                <div class="col-6 text-left">
                                    <p class="text-uppercase mb-0">#ord00922</p>
                                    <p class="text-capitalize mb-0">5 Item</p>
                                </div>
                                <div class="col-6 text-right">
                                    <p class="box-title mb-0">16:00</p>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-12">
                                ...
                                <div class="col-12">
                                    <p class="font-size-11 text-uppercase text-bold mb-0">PIC</p>
                                    <p class="mb-0">Yamikani Devi Cherish</p>
                                </div>
                            </div>
                        </div>
                        <div class="box-body pt-0 pb-0" style="margin-bottom: -1px">
                ...
                <div class="col-sm-4">
                    <div class="box">
                        <div class="box-header bg-primary">
                            <div class="row mb-4">
                                <div class="col-6 text-left">
                                    <p class="text-uppercase mb-0">#ord00923</p>
                                    <p class="text-capitalize mb-0">4 Item</p>
                                </div>
                                <div class="col-6 text-right">
                                    <p class="box-title mb-0">17:00</p>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-12">
                                ...
                                <div class="col-12">
                                    <p class="font-size-11 text-uppercase text-bold mb-0">PIC</p>
                                    <p class="mb-0">Ermolai Yvette Adrienne</p>
                                </div>
                            </div>
                        </div>
                        <div class="box-body pt-0 pb-0" style="margin-bottom: -1px">
